    ...
    content: [
      ...
      },
      {
        ...
        description: `
          ...
          <p>Example: </p>
          <code>import { defineLocale } from '@period-year-norway/ngx-bootstrap/chronos';</code><br>
          <code>import { deLocale } from '@period-year-norway/ngx-bootstrap/locale';</code><br>
