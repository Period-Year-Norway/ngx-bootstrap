...
export class BsDaterangepickerInputDirective implements ControlValueAccessor, Validator, OnInit, OnDestroy {
  ...
  constructor(
    @Host() private _picker: BsDaterangepickerDirective,
